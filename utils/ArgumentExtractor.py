...
def arg_extractor(tagged_file):
    tweebo_file=open(tagged_file,'r')
    ...
    output_file=open(tagged_file+'_args.csv','w')
    output_trainer_file = open(tagged_file + '_args_train_meta.csv', 'w')
    output_a_pos_file=open(tagged_file+'_a_pos.tsv','w')
    output_t_pos_file=open(tagged_file+'_t_pos.tsv','w')
    error_file=open(tagged_file+'_dup_errors.txt','w')
    ...
    return output_file.name, output_trainer_file.name